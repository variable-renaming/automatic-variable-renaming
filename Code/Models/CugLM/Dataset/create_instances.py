...
def main(_):
    ...
    input_files = 'token_java_pt.txt'
    input_type_files = 'type_java_pt.txt'

    token_word2id, token_vocab_size = read_vocab('data/tokens_vocab')
    type_word2id, type_vocab_size = read_vocab('data/types_vocab')
